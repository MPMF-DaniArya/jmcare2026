              ...
              child: ListView(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration:
                    const InputDecoration(labelText: "Nomor KTP"),
                  ),
                  Visibility(
                      visible: false,
                      child:
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration:
                          const InputDecoration(labelText: "RW"),
                        ),
                      )
                    ],
                  ),
                  ...
                  logic.obsKodepos.value ? Komponen.getLoadingKodeposWidget() : Container(),
                  TextFormField(
                    buildCounter: (BuildContext context,
                        {int? currentLength,
                          int? maxLength,
                  ...
                  Visibility(
                    ...
                    child: TextFormField(
                      ...
                      decoration:
                      const InputDecoration(labelText: "Alamat kantor"),
                    ),),
                  Visibility(
                    visible: false,
                    child: TextFormField(
                          ...
                          child: Stack(
                            children: [
                              state.imageKTP == null
                                  ...
                                  : Align(
                                  alignment: Alignment.center,
                                  child: Image.file(state.imageKTP!)),
                              Align(
                          ...
                          child: Stack(
                            children: [
                              state.imageProfil == null
                                  ...
                                  alignment: Alignment.center,
                                  child: Text(
                                    "Tap disini untuk mengambil foto diri",
                                    style:
                                    TextStyle(color: Colors.grey),
                                  ))
                                  : Align(
                  ...
                  CheckboxListTile(
                    title: const Text(
                        "Saya bersedia menerima penawaran produk"),
