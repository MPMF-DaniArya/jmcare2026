    ...
    return GetBuilder<HomeLogic>(
        ...
        builder: (logic) {
          return Obx(() => logic.obsLoadVersi.value
              ? Scaffold(body: Center(child: Komponen.getLoadingWidget()))
                      ...
                      children: [
                        ...
                        Container(
                          padding: const EdgeInsets.only(
                              top: 60, left: 40, right: 20, bottom: 10),
                          child: Column(
                            children: [
                              Row(
                                children: [
                              ...
                              Expanded(
                                ...
                                children: [
                                  ...
                                  Obx(() => logic.sdhLogin.value
                                      ? Container()
                                      : Komponen.linkMasukOrRegister(context)),
                                  const SizedBox(
                                    height: 40,
                                  ),
                                  Row(
                                  ...
                                  Komponen.teksJudul("Info Produk dan Layanan"),
