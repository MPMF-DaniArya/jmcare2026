  ...
  void base_send_otp(
    ...
    switch (selectedMethod){
      ...
      case 1:
        ...
        if (baseRespon is BaseError || baseRespon?.code == Konstan.tag_100 || baseRespon?.status != 'Success' || baseRespon == null){
          onOtpGagal();
        }else{
          onOtpSukses();
        }
      ...
      case 2:
        ...
        is_loading.value = false;
        if (smsRespon is SmsError || smsRespon == null){
          onOtpGagal();
        }else{
          onOtpSukses();
        }
      ...
      case 3:
        ...
        is_loading.value = false;
        if (baseRespon is BaseError || baseRespon == null || baseRespon?.code == Konstan.tag_100 || baseRespon?.status != 'OK'){
          onOtpGagal();
        }else{
          onOtpSukses();
        }
