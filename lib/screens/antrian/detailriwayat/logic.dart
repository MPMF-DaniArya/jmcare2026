...
class DetailRiwayatLogic extends BaseLogic {
  ...
  //ini fungsi kalo dia konfirmasi antrian
  //disini dia Get.back(result:"1")
  //buat pertanda di screen sebelumnya harus refresh daftar antrian
  void konfirmasiKedatangan() async {
    is_loading.value = true;
    final respon = await getService<KonfirmasikedatanganService>()
        ?.konfirmasiKedatangan(state.id);
  ...
  void getIntent() {
    ...
    state.konfirmasi_kedatangan =
        Get.arguments[Konstan.tag_konfirmasi_kedatangan];
