          ...
          return JmcareBarScreen(
            ...
            body: ListView(
              ...
              children: [
                ...
                const Text(
                    "Silakan kunjungi kantor cabang dan lakukan konfirmasi kedatangan untuk mendapatkan pelayanan."),
                const Divider(),

                const Padding(padding: EdgeInsets.only(top: 20)),
                //cek apakah tanggal antrian sama dengan hari ini
                Obx(() => logic.isToday.value //jika ini hari yang sama

                    ? logic.obxGpsSearching.value //searching lokasi
                        ? Komponen.getGpsLoading()

                        //jika jarak lebih dari 200 meter
                        : logic.obxJarak.value >= 0.05
                        // : logic.obxJarak.value >= 10000
                            ? const Column(
                                crossAxisAlignment:
                                    CrossAxisAlignment.stretch,
                                children: [
                                  Text(
                                    "Anda belum berada di kantor cabang tujuan",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: Colors.red,
                                    ),
