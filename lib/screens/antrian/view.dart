                                                ...
                                                Expanded(
                                                    child: ListView.separated(
                                                      separatorBuilder: (context, index){
                                                        ...
                                                        padding: const EdgeInsets.all(20),
                                                        itemCount: logic.riwayats.value.data == null ? 0 : logic.riwayats.value.data!.length,
                                                        itemBuilder: (BuildContext context, int index){
                                                          return InkWell(
                                                            onTap: () => logic.gotoDetail(logic.riwayats.value.data![index]),
                                                            child: Komponen.getCardRiwayatantrian(logic.riwayats.value.data![index], context)
                                                          );
                                                        }
                                                    ),
                                                )
