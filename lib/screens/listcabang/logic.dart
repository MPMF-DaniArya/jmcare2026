...
class CabangLogic extends BaseLogic{
  ...
  void getListCabang() async{
    ...
    if (cabanglist is CabangError || cabanglist == null){
  ...
  void openMap(int index) async {
    ...
    if (cR.oFFICELONG != null && cR.oFFICELAT != null){
      ...
      // await MapLauncher.launchCoordinates(office_lat, office_long);
      final availableMaps = await MapLauncher.installedMaps;

      await availableMaps.first.showMarker(
        coords: Coords(office_lat, office_long),
        title: "Kantor Cabang",
      );
