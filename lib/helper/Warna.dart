...
class Warna{
  ...
  static const Color hijau1 = Colors.green;
  static const Color hijau2 = Colors.lightGreenAccent;
  static const Color orange1 = Colors.deepOrange;
  static const Color orange2 = Colors.orangeAccent;
  static const Color greyMuda = Colors.grey;
