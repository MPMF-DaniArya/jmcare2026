...
class Endpoint {
  static const String base_url =
      "https://ws.mpm-finance.com/jmcare_dev/Service1.svc/";
  static const String base_url_jmo =
      "https://ws.mpm-finance.com/JMOrderApi_dev/Service1.svc/";
  static const String base_url_mpmi =
      "https://id.mpm-insurance.com:20011/api/JMFI/";
  static const String base_url_klaim_asuransi =
      "file://///172.16.27.20/JMCare_Data/klaim_asuransi/";
  ...
  static const String base_url_esign =
      "https://gdkwebserver.ad-ins.com/adimobile/demo/esign/services/external/";

  // static const String base_url_esign =
  //     "https://esignhub.docsol.id/adimobile/esign/services/external/";

  static const String base_url_reset_pass_sms =
      "http://web-server-api.mpmf.com/M1cr0s1t3T3st1ng/Service1.svc/";
  ...
  static const String TAG_DETAIL_PENGAJUAN_KREDIT =
      "getdtlpengajuankredit/{nomor}";
  ...
  static const String TAG_AUTOFILL_PENGAJUANKREDIT =
      "autofillpengajuankredit.json";
  ...
  static const String TAG_ANTRIAN_GET_ANTRIANBYCABANG =
      "getAntrianByCabang.json";
  static const String TAG_ANTRIAN_KONFIRMASI_KUISIONER =
      "getKonfirmasidanKuisioner.json";
  static const String TAG_ANTRIAN_GETLISTREQ_BPKB = "getlistReqBPKB/q=";
  static const String TAG_ANTRIAN_GETANTRIAN_SEKARANG =
      "getantriansekarang.json";
  static const String TAG_ANTRIAN_GETANTRIAN_ONLINE = "GetAntrianOnline.json";
  static const String TAG_ANTRIAN_KONFIRMASI_KEDATANGAN =
      "KonfirmasiKedatangan.json";
  ...
  static const String TAG_ANTRIAN_GETSUBKATEGORI =
      "getSubKategori.json/{jenis_pic}";
  static const String TAG_ANTRIAN_NOTIFIKASI_KUISIONER =
      "getNotifikasiKuisioner.json";
  ...
  static const String TAG_KONFIRMASI_TOPUP_PLAFOND =
      "konfirmasiTopupPlafond.json";
  ...
  static const String TAG_KONFIRMASI_BATAL_TOPUP_PLAFOND =
      "cekKonfBatalTopupPlafond.json";
  static const String TAG_PENCAIRAN_DAN_ANGSURAN =
      "GetPencairanDanAngsuran.json";
  static const String TAG_INSERT_TOPUPPLAFOND_JMCARE =
      "insertTopUpPlafond_JMCare.json";
  ...
  static const String TAG_LISTPARAM_CONFINS_PEKERJAAN =
      "getlistparam-confins/Pekerjaan/sKdCbg";
  static const String TAG_LISTPARAM_CONFINS_PENDIDIKANTERAKHIR =
      "getlistparam-confins/PendidikanTerakhir/sKdCbg";
  static const String TAG_VIEWLIST_STATUSPERNIKAHAN =
      "getviewlistWO/501/statuspernikahan/0";
  static const String TAG_VIEWLIST_STATUS_KEPEMILIKAN_RUMAH =
      "getviewList/StatusKepemilikanRumah/0";
  ...
  static const String TAG_VIEWLIST_SOURCE_OF_APPLICATION =
      "getviewlistsoa/0/SourceOfApplication/0/";
  ...
  static const String TAG_VIEWLIST_TUJUAN_PEMBIAYAAN =
      "getlistparam-infomedia/tujuan_pembiayaan";
  static const String TAG_VIEWLIST_ADDRESS = "GetlistAdress/{a}/{b}/{c}";
  static const String TAG_VIEWLIST_MERKKENDARAAN =
      "getlistmerkkend/{tipeJaminan}";
  ...
  static const String TAG_JMO_PENDIDIKAN =
      "getlistparam-confins/PendidikanTerakhir/sKdCbg";
  static const String TAG_JMO_STATUS_NIKAH =
      "getviewlistWO/501/statuspernikahan/0";
  ...
  static const String TAG_ESIGN_UNSIGNED_DOC =
      "document/getTotalUnsignedDocuments";
  ...
  static const String TAG_ESIGN_CHECK_STATUS_SIGN =
      "document/checkStatusSigning";
  ...
  static const String TAG_KLAIM_ASURANSI_AGREEMENT_INSCO =
      "agreementInsco.json";
  static const String TAG_KLAIM_ASURANSI_CHECK_CLAIM_AVAILABLE =
      "CheckClaimAvailable";
  static const String TAG_KLAIM_ASURANSI_INSERT_FORM_AWAL =
      "insertFormAwal.json";
  static const String TAG_KLAIM_ASURANSI_INSERT_FORM_LANJUTAN =
      "insertFormLanjutan.json";
  static const String TAG_KLAIM_ASURANSI_RIWAYAT_FORM_AWAL =
      "getRiwayatFormAwal.json";
  static const String TAG_KLAIM_ASURANSI_RIWAYAT_FORM_LANJUTAN =
      "getRiwayatFormLanjutan.json";
  static const String TAG_KLAIM_ASURANSI_UPDATE_CHECKLIST_DOCUMENT =
      "updateChecklistDokumen.json";
  static const String TAG_KLAIM_ASURANSI_GET_DOC_CHECKLIST_ASURANSI =
      "getDocumentChecklistFromAsuransi.json";
  static const String TAG_KLAIM_ASURANSI_DOWNLOAD_SURAT_KEPUTUSAN =
      "downloadSuratKeputusan.json";
  static const String TAG_KLAIM_ASURANSI_DETAIL_FORM_LANJUTAN =
      "getDetailFormLanjutan.json";
  ...
  static const String TAG_MPMI_SUBMIT_DOCUMENT_CHECKLIST =
  ...
  static const String TAG_ECONTRACT_SUBMIT_FORMPENGADUAN =
      "eContractSubmitFormPengaduan.json";
